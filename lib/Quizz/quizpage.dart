...
import 'package:jitsist/Quizz/resultpage.dart';
...
class getjson extends StatelessWidget {
  ...
  setasset() {
    if (langname == "Python") {
      ...
      assettoload = "Assets/Qns/cpp.json";
    } else {
      assettoload = "Assets/Qns/linux.json";
    }
  }
      ...
      onWillPop: () {
        return showDialog(
            ...
            builder: (context) => AlertDialog(
                  ...
                  content: Text("Are you sure want to quit the quizz"),
                  actions: <Widget>[
                    FlatButton(
                      onPressed: () {
